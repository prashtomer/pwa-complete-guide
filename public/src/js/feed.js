...
// adding to cache storage on user interaction (cache on demand)
// browser and service worker use the same cache it's not like service work has some different cache storage.
    ...
    navigator.serviceWorker.ready
      .then(function (sw) {
        ...
        writeData('sync-posts', post) // store the post request data in indexed db store
          .then(function () {
            sw.sync.register('sync-new-posts'); // register background synchronization task
          })
          .then(function () {
